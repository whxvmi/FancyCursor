...
To function properly, **FancyCursor** requires **Accessibility access** under:
...
Because **FancyCursor is not signed with an official Apple Developer ID**, macOS may display a message such as:
...
1. Right-click (or Control-click) **FancyCursor.app** in Finder  
2. Choose **Open**  
